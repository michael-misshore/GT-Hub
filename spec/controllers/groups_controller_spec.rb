...
describe GroupsController do
  ...
  #     Group.stub(:find_by_param).with("37") { mock_group }
  #     get :show, :id => "37"
  ...
  # 
  #     it "assigns the requested group as @group" do
  #       Group.stub(:find_by_param) { mock_group(:update_attributes => true) }
  #       put :update, :id => "1"
  #       assigns(:group).should be(mock_group)
  #     end
  # 
  ...
  #       Group.stub(:find_by_param) { mock_group(:update_attributes => false) }
  #       put :update, :id => "1"
  #       assigns(:group).should be(mock_group)
  #     end
  # 
  ...
  #     Group.stub(:find_by_param) { mock_group }
  #     delete :destroy, :id => "1"
